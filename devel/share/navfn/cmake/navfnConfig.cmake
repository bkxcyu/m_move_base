...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/bkxcyu/m_move_base/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/bkxcyu/m_move_base/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/bkxcyu/m_move_base/install)
...
if(NOT "/home/bkxcyu/m_move_base/devel/include;/home/bkxcyu/m_move_base/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/bkxcyu/m_move_base/devel/include;/home/bkxcyu/m_move_base/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bkxcyu/m_move_base/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
